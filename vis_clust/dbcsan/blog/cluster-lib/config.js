...
function draw(data) {
  var points = svg
    ...
    .attr("cx", function (d, i) {
      return x(30 * Math.cos(i / 5));
    })
    .attr("cy", function (d, i) {
      return y(30 * Math.sin(i / 5));
    })
...
function choose_data(callback) {
  ...
  var smiley_dat = function () {
    return smiley(500);
  };
  var unif_dat = function () {
    return uniform(250);
  };
  var threenorm_dat = function () {
    return threenorm(250);
  };
  var pimples_dat = function () {
    return pimples(500);
  };
  var circles = function () {
    return circle_pack(500);
  };
  var density = function () {
    return density_bars(500);
  };
  var dbscan_dat = function () {
    return dbscan_all();
  };
  var dbscan_nonunique = function () {
    return dbscan_borders();
  };
  ...
  var title = { text: "Pilih Jenis Data yang Anda Inginkan", x: -14, y: 9 };
