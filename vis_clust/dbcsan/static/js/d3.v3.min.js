d3 = (function () {
  ...
  function A(n) {
    return (
      arguments.length || (n = vo.ascending),
      function (t, e) {
  ...
  function z(n, t, e) {
    ...
    function i() {
      var t,
        e = new RegExp("^__on([^.]+)" + vo.requote(n) + "$");
      for (var r in this)
        if ((t = r.match(e))) {
          var u = this[r];
  ...
  function K(n, t, e) {
    ...
    return (
      ...
      (i = nt(i) * la),
      it(
        et(3.2404542 * u - 1.5371385 * r - 0.4985314 * i),
        et(-0.969266 * u + 1.8760108 * r + 0.041556 * i),
        et(0.0556434 * u - 0.2040259 * r + 1.0572252 * i)
      )
    );
  }
  function Q(n, t, e) {
    return n > 0
      ? B(Math.atan2(e, t) * Go, Math.sqrt(t * t + e * e), n)
      : B(0 / 0, 0 / 0, n);
  }
  function nt(n) {
  ...
  function st(n, t, e) {
    ...
    var r = tt((0.4124564 * n + 0.3575761 * t + 0.1804375 * e) / aa),
      u = tt((0.2126729 * n + 0.7151522 * t + 0.072175 * e) / ca),
      i = tt((0.0193339 * n + 0.119192 * t + 0.9503041 * e) / la);
  ...
  function yt() {
    var n = xt(),
      t = bt() - n;
    t > 24
      ? (isFinite(t) && (clearTimeout(va), (va = setTimeout(yt, t))), (da = 0))
      : ((da = 1), ya(yt));
  }
  function Mt(n, t, e) {
        ...
        v = {
          ...
          polygonEnd: function () {
            (v.point = i),
              ...
              h.length
                ? Zt(h, Jt, null, e, u)
                : r(g) && (u.lineStart(), e(null, null, 1, u), u.lineEnd()),
              u.polygonEnd(),
              (h = g = null);
          },
          sphere: function () {
  ...
  function Jt(n, t) {
    return (
      ((n = n.point)[0] < 0 ? n[1] - Bo / 2 - $o : Bo / 2 - n[1]) -
      ((t = t.point)[0] < 0 ? t[1] - Bo / 2 - $o : Bo / 2 - t[1])
    );
  }
  function Gt(n, t) {
    var e = n[0],
      ...
      if (h) {
        for (
          ...
          var M = n[0],
            ...
            E = v * b;
          if (
            (Ca.add(Math.atan2(E * Math.sin(w), m * _ + E * Math.cos(w))),
            Math.abs(x) < $o && (a = !0),
            (i += S ? w + (w >= 0 ? 2 : -2) * Bo : w),
            S ^ (p >= e) ^ (M >= e))
          ) {
    ...
    function r(n, t, e) {
      ...
      if (!(0 > M)) {
        ...
        if (
          ...
          q
            ? N
              ? (E + k > 0) ^ (b[1] < (Math.abs(b[0] - w) < $o ? E : k))
              : E <= b[1] && b[1] <= k
            : (A > Bo) ^ (w <= b[0] && b[0] <= S))
        ) {
          var T = Lt(v, (-m + x) / y);
  ...
  function re(n, t, e, r) {
    ...
    function a(u, i) {
      var o = i[0] - u[0],
        a = i[1] - u[1],
        c = [0, 1];
      return Math.abs(o) < $o && Math.abs(a) < $o
    ...
    return function (c) {
      ...
      function v() {
        y && (m(b, _), w && k && q.rejoin(), y.push(q.buffer())),
          (T.point = p),
          k && c.lineEnd();
      }
      function m(n, t) {
      ...
      var y,
        ...
        T = {
          ...
          polygonEnd: function () {
            (c = N),
              (y = vo.merge(y)).length
                ? (c.polygonStart(), Zt(y, i, l, h, c), c.polygonEnd())
                : s([n, t]) &&
                  (c.polygonStart(),
                  c.lineStart(),
                  h(null, null, 1, c),
    ...
    function e(t, i, o, a, c, l, s, f, h, g, p, d, v, m) {
      ...
      if (x > 4 * r && v--) {
        var b = a + g,
          ...
          C = M * T - y * z;
        ((C * C) / x > r ||
          Math.abs((y * T + M * z) / x - 0.5) > 0.3 ||
          u > a * g + c * p + l * d) &&
          (e(t, i, o, a, c, l, N, q, k, (b /= S), (_ /= S), w, v, m),
          m.point(N, q),
  ...
  function Ne(n, t) {
    ...
    return function (u, i, o, a) {
      ...
      null != u
        ? ((u = qe(e, u)),
          (i = qe(e, i)),
          (o > 0 ? i > u : u > i) && (u += 2 * o * Bo))
        : ((u = n + 2 * o * Bo), (i = n - 0.5 * c));
    ...
    var u = Math.cos(t),
      ...
      p = h
        ? function (n) {
            ...
            return [
              Math.atan2(u, r) * Go,
              Math.atan2(o, Math.sqrt(r * r + u * u)) * Go,
            ];
          }
        : function () {
            return [n * Go, t * Go];
  ...
  function Fe(n, t) {
    ...
    return i
      ? ((e.invert = function (n, t) {
          ...
          return [
            Math.atan2(n, e) / i,
            2 * Math.atan(Math.pow(o / r, 1 / i)) - Bo / 2,
          ];
        }),
        e)
      : Oe;
  ...
  function Ie(n) {
    function t(t) {
      ...
      for (
        var c, l = [], s = [], f = -1, h = t.length, g = gt(e), p = gt(r);
        ++f < h;
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((o = "function" == typeof n ? (i = n) : (i = fc.get(n) || Ze).key),
            t)
          : o;
      }),
  ...
  function Sr(n, t) {
    for (
      var e, r = vo.interpolators.length;
      --r >= 0 && !(e = vo.interpolators[r](n, t));
  ...
  function Ur(n) {
    ...
    t[0] * e[1] < e[0] * t[1] &&
      ((t[0] *= -1), (t[1] *= -1), (r *= -1), (u *= -1)),
      (this.rotate =
        (r ? Math.atan2(t[1], t[0]) : Math.atan2(-e[0], e[1])) * Go),
    ...
    return (
      a[0] != c[0] || a[1] != c[1]
        ? (r.push("translate(", null, ",", null, ")"),
          u.push({ i: 1, x: _r(a[0], c[0]) }, { i: 3, x: _r(a[1], c[1]) }))
        : c[0] || c[1]
        ? r.push("translate(" + c + ")")
        : r.push(""),
      l != s
      ...
      f != h
        ? u.push({ i: r.push(r.pop() + "skewX(", null, ")") - 2, x: _r(f, h) })
  ...
  function Kr(n, t) {
    if (n === t) return n;
    for (
      var e = Gr(n), r = Gr(t), u = e.pop(), i = r.pop(), o = null;
      u === i;
  ...
  function uu(n, t) {
    return (
      vo.rebind(n, t, "sort", "children", "value"),
      (n.nodes = n),
      (n.links = cu),
      n
    );
  ...
  function wu(n, t) {
    var e = n.children;
    if (e && (u = e.length))
      for (var r, u, i = -1; ++i < u; ) t((r = wu(e[i], t)), n) > 0 && (n = r);
    return n;
  }
  function Su(n, t) {
    return n.x - t.x;
      ...
      if (
        ...
        for (
          ...
          if (1 == p)
            for (
              c = r._pack_prev;
              c !== a._pack_prev && !ju(c, i);
              c = c._pack_prev, v++
            );
          p
            ? (v > d || (d == v && u.r < r.r) ? Du(r, (u = a)) : Du((r = c), u),
              o--)
            : (Cu(r, i), (u = i), t(i));
        }
      var m = (s + f) / 2,
  ...
  function Pu(n, t, e, r) {
    ...
    if (((n.x = t += r * n.x), (n.y = e += r * n.y), (n.r *= r), u))
      for (var i = -1, o = u.length; ++i < o; ) Pu(u[i], t, e, r);
  }
  function Ou(n, t, e) {
    var r = n.r + e.r,
      u = t.x - n.x,
  ...
  function ri(n, t, e) {
    var r = -Math.floor(Math.log(ti(n, t)[2]) / Math.LN10 + 0.01);
    return vo.format(
      e
        ? e.replace(Sa, function (n, t, e, u, i, o, a, c, l, s) {
            return [
              t,
              e,
              u,
  ...
  function ui(n, t, e, r) {
    ...
    return (
      ...
      (o.tickFormat = function (n, t) {
        ...
        arguments.length < 2
          ? (t = Nc)
          : "function" != typeof t && (t = vo.format(t));
        var r,
  ...
  function ii(n, t, e) {
    ...
    return (
      ...
      (r.exponent = function (o) {
        return arguments.length
          ? ((u = oi((t = o))), (i = oi(1 / t)), n.domain(e.map(u)), r)
          : t;
      }),
      (r.copy = function () {
  ...
  function mi(n) {
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((c = "function" == typeof n ? (a = n) : (a = fc.get(n) || Ze).key),
            (l = a.reverse || a),
            (s = a.closed ? "M" : "L"),
            t)
          : c;
          ...
          "j" in e
            ...
            ? (u.setFullYear(e.y, 0, 1),
              u.setFullYear(
                ...
                0,
                "W" in e
                  ? ((e.w + 6) % 7) + 7 * e.W - ((u.getDay() + 5) % 7)
                  : e.w + 7 * e.U - ((u.getDay() + 6) % 7)
              ))
  ...
  (vo.ascending = function (n, t) {
    ...
    (vo.median = function (t, e) {
      return (
        ...
        (t = t.filter(n)),
        t.length ? vo.quantile(t.sort(vo.ascending), 0.5) : void 0
      );
    }),
    ...
    (Oo.selectAll = function (n) {
      ...
      for (var u = -1, i = this.length; ++u < i; )
        for (var o = this[u], a = -1, c = o.length; ++a < c; )
          (e = o[a]) &&
            (r.push((t = yo(n.call(e, e.__data__, a, u)))), (t.parentNode = e));
      return p(r);
    });
  var Ro = {
  ...
  (vo.ns = {
    ...
    qualify: function (n) {
      ...
      return (
        ...
        Ro.hasOwnProperty(e) ? { space: Ro[e], local: n } : n
      );
    },
  }),
  ...
  (vo.interpolateZoom = function (n, t) {
    ...
    (vo.behavior.zoom = function () {
      ...
      function s() {
        ...
        function h() {
          vo.event.touches.length
            ? n()
            : (y.on(z, null).on(C, null), x.on(A, l).on(T, s), b(), c(v));
        }
        var g,
          p,
          d = this,
          v = D.of(d, arguments),
          m = 0,
          y = vo.select(bo).on(z, i).on(C, h),
          x = vo.select(d).on(A, null).on(T, e),
          b = j();
        Ei.call(d), e(), o(v);
      }
      function h() {
        var n = D.of(this, arguments);
        y ? clearTimeout(y) : (Ei.call(this), o(n)),
          (y = setTimeout(function () {
            (y = null), c(n);
          }, 50)),
          f();
        var e = m || vo.mouse(this);
        v || (v = t(e)), r(Math.pow(2, 0.002 * ta()) * S.k), u(e, v), a(n);
      }
      function p() {
        v = null;
      }
      function d() {
        ...
        o(n),
          r(
            Math.pow(
              2,
              vo.event.shiftKey ? Math.ceil(l) - 1 : Math.floor(l) + 1
            )
          ),
          u(e, i),
          a(n),
    ...
    (vo.hcl = function (n, t, e) {
      return 1 === arguments.length
        ? n instanceof $
          ...
          : n instanceof G
          ? Q(n.l, n.a, n.b)
          : Q((n = st((n = vo.rgb(n)).r, n.g, n.b)).l, n.a, n.b)
        : B(+n, +t, +e);
    });
  ...
  (vo.timer = function (n, t, e) {
    ...
    pa ? (pa.next = i) : (ga = i),
      (pa = i),
      da || ((va = clearTimeout(va)), (da = 1), ya(yt));
  }),
  ...
  var Sa =
    ...
    Ea = vo.map({
      ...
      r: function (n, t) {
        return (n = vo.round(n, wt(n, t))).toFixed(
  ...
  (vo.geo.bounds = (function () {
    ...
    (vo.geo.centroid = function (n) {
      ...
      return Wo > u &&
        ...
        Wo > u)
        ? [0 / 0, 0 / 0]
        : [Math.atan2(e, t) * Go, P(r / Math.sqrt(u)) * Go];
    });
  var ja,
    La,
    Ha,
        ...
        (n.translate = function (t) {
          ...
          return (
            ...
            (r = o
              ...
              .clipExtent([
                [s - 0.425 * l + $o, f + 0.12 * l + $o],
                [s - 0.214 * l - $o, f + 0.234 * l - $o],
              ])
              .stream(c).point),
            (u = a
              .translate([s - 0.205 * l, f + 0.212 * l])
              .clipExtent([
                [s - 0.214 * l + $o, f + 0.166 * l + $o],
                [s - 0.115 * l - $o, f + 0.234 * l - $o],
              ])
              .stream(c).point),
            n
          );
  ...
  (vo.geo.transform = function (n) {
    ...
    (vo.geo.rotation = function (n) {
      ...
      return (
        (n = Se((n[0] % 360) * Jo, n[1] * Jo, n.length > 2 ? n[2] * Jo : 0)),
        (t.invert = function (t) {
          return (
            (t = n.invert(t[0] * Jo, t[1] * Jo)), (t[0] *= Go), (t[1] *= Go), t
          );
        }),
        t
      );
    ...
    (vo.geo.graticule = function () {
      ...
      function t() {
        return vo
          ...
          .map(h)
          .concat(vo.range(Math.ceil(l / m) * m, c, m).map(g))
          .concat(
            vo
    ...
    (dc.clip = function (n) {
      for (
        ...
        for (
          ...
          (o = t[e]),
            hr(o, s, u)
              ? (hr(i, s, u) || n.push(gr(i, o, s, u)), n.push(o))
              : hr(i, s, u) && n.push(gr(i, o, s, u)),
            (i = o);
        a && n.push(n[0]), (s = u);
      }
      return n;
  ...
  (vo.geom.quadtree = function (n, t, e, r, u) {
    ...
    return (o = arguments.length)
      ? ((a = vr), (c = mr), 3 === o && ((u = e), (r = t), (e = t = 0)), i(n))
      : ((i.x = function (n) {
    ...
    (vo.layout.force = function () {
      ...
      return (
        (a.tick = function () {
          ...
          if (g)
            for (ru((t = vo.geom.quadtree(v)), r, o), e = -1; ++e < b; )
  ...
  vo.layout.stack = function () {
    ...
    return (
      ...
      (n.order = function (t) {
        return arguments.length
          ? ((e = "function" == typeof t ? t : Ec.get(t) || hu), n)
          : e;
      }),
      (n.offset = function (t) {
        return arguments.length
          ? ((r = "function" == typeof t ? t : kc.get(t) || gu), n)
          : r;
      }),
      (n.x = function (t) {
        return arguments.length ? ((i = t), n) : i;
      ...
      if (g > 0)
        for (i = -1; ++i < h; )
          (a = l[i]),
            a >= s[0] &&
              a <= s[1] &&
              ((o = c[vo.bisect(f, a, 1, g) - 1]), (o.y += p), o.push(n[i]));
      return c;
    }
    var t = !0,
      e = Number,
          ...
          if (t) {
            for (
              ...
              (c = bu(c)),
                ...
                u > 0 && (qu(Tu(a, n, r), n, u), (l += u), (s += u)),
                (f += a._tree.mod),
                (l += i._tree.mod),
                (h += c._tree.mod),
                (s += o._tree.mod);
            a && !_u(o) && ((o._tree.thread = a), (o._tree.mod += f - s)),
              i &&
                !bu(c) &&
      ...
      return (
        ...
        (i.padding = function (n) {
          function t(t) {
            ...
            return null == e
              ? Vu(t)
              : Zu(t, "number" == typeof e ? [e, e, e, e] : e);
          }
          function e(t) {
            return Zu(t, n);
          }
  ...
  (Yc.call = Oo.call),
    ...
    (Oo.transition = function () {
      for (
        var n,
          ...
          e = Fc || ++Ic,
          r = [],
          u = Pc || { time: Date.now(), ease: zr, delay: 0, duration: 250 },
          i = -1,
          o = this.length;
        ++i < o;
      ...
      function u(t) {
        return null == t
          ...
          : ((t += ""),
            function () {
              var r,
                u = bo.getComputedStyle(this, null).getPropertyValue(n);
              return (
                u !== t &&
                ((r = Sr(u, t)),
                function (t) {
    ...
    (Yc.styleTween = function (n, t, e) {
      function r(r, u) {
        var i = t.call(
          ...
          r,
          u,
          bo.getComputedStyle(this, null).getPropertyValue(n)
        );
        return (
          i &&
          function (t) {
    ...
    (Yc.ease = function (n) {
      ...
      return arguments.length < 1
        ...
        : ("function" != typeof n && (n = vo.ease.apply(vo, arguments)),
          N(this, function (e) {
    ...
    (Yc.transition = function () {
      for (
        var n, t, e, r, u = this.id, i = ++Ic, o = [], a = 0, c = this.length;
        c > a;
        a++
      ) {
        o.push((n = []));
      ...
      function n(n) {
        n.each(function () {
          var n,
            ...
            f = null == t ? (e.tickFormat ? e.tickFormat.apply(e, a) : pt) : t,
            h = l.selectAll(".tick").data(s, pt),
            g = h
              .enter()
              .insert("g", ".domain")
              .attr("class", "tick")
              .style("opacity", 1e-6),
            p = vo.transition(h.exit()).style("opacity", 1e-6).remove(),
            d = vo.transition(h).style("opacity", 1),
            v = Bu(e),
  ...
  vo.svg.brush = function () {
    ...
    function u() {
      ...
      function g() {
        32 == vo.event.keyCode &&
          (q || ((x = null), (z[0] -= s[1]), (z[1] -= h[1]), (q = 2)), f());
      }
      function v() {
        32 == vo.event.keyCode &&
          2 == q &&
          ((z[0] += s[1]), (z[1] += h[1]), (q = 0), f());
      }
      function m() {
        var n = u(),
          i = !1;
        b && ((n[0] += b[0]), (n[1] += b[1])),
          ...
          A && y(n, c, 0) && (e(E), (i = !0)),
          N && y(n, l, 1) && (r(E), (i = !0)),
          i && (t(E), S({ type: "brush", mode: q ? "move" : "resize" }));
      }
      function y(n, t, e) {
        var r,
          u,
      ...
      var x,
        ...
        T = j(),
        z = u(),
        C = vo.select(bo).on("keydown.brush", g).on("keyup.brush", v);
      if (
        (vo.event.changedTouches
          ? C.on("touchmove.brush", m).on("touchend.brush", M)
          : C.on("mousemove.brush", m).on("mouseup.brush", M),
  ...
  (Bc.year = Ci(
    ...
    Wc.forEach(function (n, t) {
      ...
      var e = (Bc[n] = Ci(
        function (n) {
          return (
            (n = Bc.day(n)).setDate(n.getDate() - ((n.getDay() + t) % 7)), n
          );
        },
        function (n, t) {
