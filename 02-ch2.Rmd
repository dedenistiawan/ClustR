...
```{r, fig.align='center', echo=FALSE, fig.cap="Matrik Jarak"}
library(ggplot2)
library(factoextra)
...
```{r, fig.align='center', echo=FALSE, fig.cap="Plot Jumlah Cluster Metode Elbow"}
...
```{r, fig.align='center', echo=FALSE, fig.cap="Plot Jumlah Cluster Metode silhouette"}
...
```{r, fig.align='center', echo=FALSE, fig.cap="Komparasi Plot Jumlah Cluster"}
# komparasi plot
...
```{r, fig.align='center', echo=FALSE, fig.cap="Plot Jumlah Cluster"}
library(gridExtra)
...
```{r, fig.align='center', echo=FALSE, fig.cap="Plot Hasil Cluster"}
km.res$centers
