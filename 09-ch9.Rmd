...
```{r, fig.align='center', fig.cap="Visualisasi Dendogram"}
library(factoextra)
...
```{r, fig.align='center', fig.cap="Visualisasi Dendogram Horisontal"}
...
```{r, fig.align='center', fig.cap="Visualisasi Dendogram 4 Kelompok"}
...
```{r, fig.align='center', fig.cap="Visualisasi Dendogram Bentuk Melingkar"}
fviz_dend(hasil_cluster, cex = 0.5, k=4,
...
```{r, fig.align='center', fig.cap="Visualisasi Dendogram Bentuk Filogenetik"}
require("igraph")
...
```{r, fig.align='center', fig.cap="Visualisasi Dendogram Subtree 1"}
# Plot subtree 1
...
```{r, fig.align='center', fig.cap="Visualisasi Dendogram Subtree 2"}
# Plot subtree 2
