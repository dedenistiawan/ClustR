...
\caption{Visualisasi Data}(\#fig:unnamed-chunk-4)
\end{figure}
...
\caption{Jumlah Cluster Optimal}(\#fig:unnamed-chunk-5)
\end{figure}
...
\caption{Visualisasi silhouette}(\#fig:unnamed-chunk-8)
\end{figure}
...
\caption{Visualisasi Hasil Cluster}(\#fig:unnamed-chunk-9)
\end{figure}
