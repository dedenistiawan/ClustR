...
<img src="09-ch9_files/figure-html/unnamed-chunk-4-1.png" width="80%" style="display: block; margin: auto;" />
...
#> Cl.1          7.7         2.8          6.7         2.0
#> Cl.2          5.9         3.0          4.2         1.5
#> Cl.3          4.6         3.6          1.0         0.2
```
