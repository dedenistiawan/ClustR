...
Dengan menggunakan fungsi `read.csv()` dari \texttt{R}, kami dapat mengimpor data langsung dari URL tersebut ke dalam lingkungan kerja \texttt{R}. Berikut adalah kode yang digunakan untuk membaca data:
...
\caption{(\#tab:nice-tab-km)Basis Data Terpadu Jawa Tengah}
\centering
...
\caption{Matrik Jarak}(\#fig:unnamed-chunk-4)
\end{figure}
...
\caption{Plot Jumlah Cluster Metode Elbow}(\#fig:unnamed-chunk-5)
\end{figure}
...
\caption{Plot Jumlah Cluster Metode silhouette}(\#fig:unnamed-chunk-6)
\end{figure}
...
\caption{Plot Jumlah Cluster}(\#fig:unnamed-chunk-9)
\end{figure}
...
\caption{Plot Hasil Cluster}(\#fig:unnamed-chunk-13)
\end{figure}
...
\caption{Plot Hasil Cluster}(\#fig:unnamed-chunk-14)
\end{figure}
