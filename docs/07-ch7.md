...
\caption{Visualisasi Dendogram}(\#fig:unnamed-chunk-4)
\end{figure}
...
\caption{Visualisasi Dendogram Horisontal}(\#fig:unnamed-chunk-5)
\end{figure}
...
\caption{Visualisasi Dendogram 4 Kelompok}(\#fig:unnamed-chunk-6)
\end{figure}
...
\caption{Visualisasi Dendogram}(\#fig:unnamed-chunk-7)
\end{figure}
...
\caption{Visualisasi Dendogram}(\#fig:unnamed-chunk-8)
\end{figure}
...
\caption{Visualisasi Dendogram Bentuk Melingkar}(\#fig:unnamed-chunk-9)
\end{figure}
...
\caption{Visualisasi Dendogram Bentuk Filogenetik}(\#fig:unnamed-chunk-10)
\end{figure}
...
\caption{Visualisasi Dendogram}(\#fig:unnamed-chunk-12)
\end{figure}
...
\caption{Visualisasi Dendogram Subtree 1}(\#fig:unnamed-chunk-13)
\end{figure}
...
\caption{Visualisasi Dendogram Subtree 2}(\#fig:unnamed-chunk-14)
\end{figure}
